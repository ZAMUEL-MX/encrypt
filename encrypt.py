...
def main():
    ...
    if choice == '9' or choice == '09':
        ...
        if choice == '10':
            print '\n\tAUTHOR\n\t===================================\n\tCREATED BY : Zamuel Security\n\tCODED BY   : ZAMUEL\n\tGITHUB     : https://github.com/ZAMUEL-MX\n\t\t     \n\tREPORT BUG ON FACEBOOK OR INSTAGRAM\n\t===================================\n\tfb : Deray\n\tig : reyy05_\n\t===================================\n\t'
            main()
        else:
